 ...
 * Socket constructor.
 *
 * @param {String|Object} uri or options_list
 * @param {Object} options_list
 * @api public
 */
...
function Socket(uri, opts){
  ...
  // SSL options_list for Node.js client
 ...
 *
 * @api {Object} connection options_list
 * @api public
 */
...
module.exports = function(val, options_list){
  options_list = options_list || {};
  if ('string' == typeof val) return parse(val);
  return options_list.long
    ? long(val)
    : short(val);
};
...
function BlobBuilderConstructor(ary, options_list) {
  options_list = options_list || {};
  ...
  return (options_list.type) ? bb.getBlob(options_list.type) : bb.getBlob();
};
 ...
 * WebSocket constructor.
 *
 * The third `opts` options_list object gets ignored in web browsers, since it's
